...
def PictureMaker2(day):
    a=open(r"/home/vincenthuang282/StockAndTelegram/result_file/發行量加權股價指數.csv","r",encoding="utf-8",newline="")
    reader=csv.reader(a)
    Date=[]
    Date_reverse=[]
    Date_value=[]
    ...
    plt.tight_layout()
    plt.savefig(r"/home/vincenthuang282/StockAndTelegram/picture/result2.jpg")
    plt.close()
    ##plt.show()
