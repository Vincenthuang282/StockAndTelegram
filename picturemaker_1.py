...
def PictureMaker(input,day):
    ...
    if(day=='30'):
        ...
        size=4
        days=60
    dir = r"C:\Users\VINCENT\OneDrive\桌面\StockAndTelegram\result_file"
...
#############------------------------------------------------------------------------##################################  
    ...
    for k in range(0,len(selects),1):
        ...
        a=open(r"C:/Users/VINCENT/OneDrive/桌面/StockAndTelegram/result_file/"+selects[k]+'.csv','r',encoding='utf-8',newline='')
        reader=csv.reader(a)
        status.append([])
...
##################------------------------------------------------------------------############################
    ...
    plt.tight_layout()
    plt.savefig(r"C:\Users\VINCENT\OneDrive\桌面\StockAndTelegram\picture\result.jpg")
    plt.close()
    #plt.show()
